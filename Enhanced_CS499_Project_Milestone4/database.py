...
class AnimalShelter:
    ...
    def __init__(self, config: AppConfig):
        ...
        client_options = {
            ...
            "retryReads": True,
            "retryWrites": True,
            "appname": "Grazioso Salvare Dashboard",
        }
    ...
    def read(self, query, projection=None):
        ...
        safe_projection = validate_projection(projection)
        try:
            return list(self.collection.find(safe_query, safe_projection))
        except PyMongoError as exc:
    ...
    def __enter__(self):
        """Allow the connection to be used with a with statement."""
        return self

    def __exit__(self, exc_type, exc_value, traceback):
        """Always close the connection when leaving a with statement."""
        self.close()
